...
def train(config_path, cuda):
    ...
    optimizer = torch.optim.SGD(
        ...
        params=[
            {"params": model.module.layer1.parameters(), "lr": CONFIG.SOLVER.LR, "weight_decay": CONFIG.SOLVER.WEIGHT_DECAY},
            {"params": model.module.layer2.parameters(), "lr": CONFIG.SOLVER.LR, "weight_decay": CONFIG.SOLVER.WEIGHT_DECAY},
            {"params": model.module.layer3.parameters(), "lr": CONFIG.SOLVER.LR, "weight_decay": CONFIG.SOLVER.WEIGHT_DECAY},
            {"params": model.module.layer4.parameters(), "lr": CONFIG.SOLVER.LR, "weight_decay": CONFIG.SOLVER.WEIGHT_DECAY},
            {"params": model.module.layer5.parameters(), "lr": CONFIG.SOLVER.LR, "weight_decay": CONFIG.SOLVER.WEIGHT_DECAY},
            {"params": model.module.fc1.parameters(), "lr": CONFIG.SOLVER.LR, "weight_decay": CONFIG.SOLVER.WEIGHT_DECAY},
            {"params": model.module.fc2.parameters(), "lr": CONFIG.SOLVER.LR, "weight_decay": CONFIG.SOLVER.WEIGHT_DECAY},
            {"params": model.module.reduce.parameters(), "lr": CONFIG.SOLVER.LR, "weight_decay": CONFIG.SOLVER.WEIGHT_DECAY},
            {"params": model.module.aspp.parameters(), "lr": 10 * CONFIG.SOLVER.LR, "weight_decay": CONFIG.SOLVER.WEIGHT_DECAY},
            # {
