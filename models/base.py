...
from . import resnet
from bdd.encoding.utils import batch_pix_accuracy, batch_intersection_union
...
class BaseNet(nn.Module):
    def __init__(self, nclass, backbone, aux, se_loss, dilated=True, norm_layer=None,
                 ...
                 multi_grid=False, multi_dilation=None, inplanes=64,
                 input_ch=3):
        ...
        if backbone == 'resnet34':
            self.pretrained = resnet.resnet34(pretrained=True, dilated=dilated,
                                              ...
                                              multi_grid=multi_grid, multi_dilation=multi_dilation, inplanes=inplanes)
